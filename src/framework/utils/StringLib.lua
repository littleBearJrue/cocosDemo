...
function string.printArray(array, showindex)
...
function string.printTable(_table)
...
local function dectobin(dec, limit)
	if (limit == '' or limit == nil) then
		limit = 8
	end
